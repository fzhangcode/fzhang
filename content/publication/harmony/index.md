...
# Authors. 
authors = ["Korsunsky, I.", "Millard, N.", "Fan, J.", "Slowikowski, K.", "**Zhang, F.**", "Wei, K.", "Baglaenko, Y.", "Brenner, M.", "Loh, P.", "Raychaudhuri, S."]
...
# Links (optional).
url_pdf = "https://www.ncbi.nlm.nih.gov/pubmed/?term=Fast%2C+sensitive+and+accurate+integration+of+single-cell+data+with+Harmony"
